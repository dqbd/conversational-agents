...
export const second = streamProcedure
  .input(
    z.object({
      query: z.string(),
  ...
  .mutation(async ({ append, input }) => {
    ...
    /**
     * { role: "system", content: "Jak se má chovat chatbot" }
     * { role: "user", content: "Jak se má chovat chatbot" }
     * { role: "assistant", content: "Jak se má chovat chatbot" }
     * { role: "user", content: "Jak se má chovat chatbot" }
     * { role: "assistant", content: "Jak se má chovat chatbot" }
     * { role: "user", content: "Jak se má chovat chatbot" }
     */
